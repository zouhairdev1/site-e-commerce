...
<div className=" relative">
   <span className="[&>svg]:w-6 [&>svg]:stroke-black/50">
                ...
                {itemsLength>0 &&  <span
            className="absolute  bg-red-500  top-3 left-2   text-white -mt-4 ms-2.5 rounded-full bg-danger shadow px-[0.35rem] py-[0.15em] text-[0.6rem] font-bold leading-none "
            >{itemsLength}</span>}
