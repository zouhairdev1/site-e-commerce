...
const customStyles = {
    control: (provided, state) => ({
        ...
        '&:hover': {
            borderColor: 'black' // Ensure black border on hover
        },
        height: '40px', // Set the height
        minHeight: '40px', // Ensure the minimum height is consistent
        borderRadius: '0.5rem' // Tailwind's rounded-lg equivalent in rem
    }),
    option: (provided) => ({
        ...provided,
        color: 'black',
    ...
    valueContainer: (provided) => ({
        ...provided,
        height: '40px', // Ensure value container height matches the control height
        display: 'flex',
        alignItems: 'center'
    }),
    input: (provided) => ({
...
export default function VonderAcount() {
    return (
        <>
        <div className="text-center">
            <h1 className="text-3xl font-bold text-zinc-800 mt-8 mb-40">Create your account</h1>
        </div>
...
export const countries = [
    { value: 'us', label: 'United States', phoneCode: '+1', flag: "https://flagcdn.com/us.svg" },
    { value: 'ca', label: 'Canada', phoneCode: '+1', flag: "https://flagcdn.com/ca.svg" },
    { value: 'gb', label: 'United Kingdom', phoneCode: '+44', flag: "https://flagcdn.com/gb.svg" },
    { value: 'sa', label: 'Saudi Arabia', phoneCode: '+966', flag: "https://flagcdn.com/sa.svg" },
    { value: 'ae', label: 'United Arab Emirates', phoneCode: '+971', flag: "https://flagcdn.com/ae.svg" },
    { value: 'eg', label: 'Egypt', phoneCode: '+20', flag: "https://flagcdn.com/eg.svg" },
    { value: 'ma', label: 'Morocco', phoneCode: '+212', flag: "https://flagcdn.com/ma.svg" },
    { value: 'dz', label: 'Algeria', phoneCode: '+213', flag: "https://flagcdn.com/dz.svg" },
    { value: 'jo', label: 'Jordan', phoneCode: '+962', flag: "https://flagcdn.com/jo.svg" },
    { value: 'lb', label: 'Lebanon', phoneCode: '+961', flag: "https://flagcdn.com/lb.svg" },
    { value: 'qa', label: 'Qatar', phoneCode: '+974', flag: "https://flagcdn.com/qa.svg" },
    { value: 'kw', label: 'Kuwait', phoneCode: '+965', flag: "https://flagcdn.com/kw.svg" },
...
const LoginForm = () => {
    ...
    return (
        <form>
            ...
            <InputField label="Number of CIN" type="text" id="cin" placeholder="Number of CIN" />
...
const PhoneNumberInput = ({ selectedPhoneCode, setSelectedPhoneCode, phoneNumber, setPhoneNumber }) => {
    return (
        <div className="flex items-center border border-black rounded-lg">
            ...
            <input
                ...
                className="bg-white dark:bg-white p-2 rounded-lg border border-white dark:white focus:outline-none w-3/4"
